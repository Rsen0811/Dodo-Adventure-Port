...
class ProjectileDodo
{
    ...
    public ProjectileDodo(Vector2 dodoPos, float walkSpeed = 120, float runSpeed = 340, float chaseDist = 400, int maxHealth = 2, float chargeLength = 1.4f, 
